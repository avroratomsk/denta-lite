(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".icon-menu")) {
                ...
                document.querySelector(".menu-mb").classList.toggle("_show-menu");
            }
        }));
    }
    ...
    function initSliders() {
        ...
        if (document.querySelector(".index-doctors__slider")) new swiper_core_Swiper(".index-doctors__slider", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
    ...
    if (submenuOverlay) submenuOverlay.addEventListener("click", (function(e) {
        this.classList.remove("_active");
        submenuTrigerBtn.classList.remove("_active");
        document.querySelector(".sub-menu").classList.remove("_show-submenu");
    }));
    const submenu = document.querySelector(".submenu");
    if (submenu) submenu.addEventListener("click", (function(e) {
    ...
    if (submenuItem) submenuItem.forEach((item => {
    ...
    if (menuSwitchers) menuSwitchers.forEach((btn => {
    ...
    if (menuMobileCloseBtn) menuMobileCloseBtn.addEventListener("click", (function(e) {
        bodyUnlock();
    ...
    if (bodyElement) bodyElement.addEventListener("click", (function(e) {
        if (menuMobile.classList.contains("_show-menu")) if (!e.target.classList.contains("_show-menu") && !e.target.closest(".menu-mb")) {
            bodyUnlock();
            document.documentElement.classList.remove("menu-open");
            document.querySelector(".menu-mb").classList.remove("_show-menu");
        }
